...
using System.Linq;
using UC = NanoXLSX.Demo.UseCases;

namespace NanoXLSX.Demo
{
    /// <summary>
    /// Main class to run NanoXLSX demo use cases
    /// </summary>
    public class Program
    {
        private static readonly Dictionary<string, (Action Run, string Description)> UseCases = new()
        {
            ...
            { "Read", (UC.Read.Run, "Load and read an existing Excel file") },
            ...
            { "InlineFormattingRead", (UC.InlineFormattingRead.Run, "Reading cells with inline formatting") }
        };
        ...
        /// - Comma-separated use case names or numbers: Runs specified use cases (e.g., "BasicDemo,Read" or "1,2")
        /// </param>
        static void Main(string[] args)
        {
            Console.WriteLine("=================================================");
            Console.WriteLine("  NanoXLSX Demo - Use Case Examples (v3.x)");
            Console.WriteLine("=================================================\n");
